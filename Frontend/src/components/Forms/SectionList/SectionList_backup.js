  ...
  return (
    <TableContainer component={Paper}>
      <Table sx={{ maxWidth: 1200 }} aria-label="simple table">
        ...
        <TableBody>
          {props.editTestFormationSections
            ? props.editTestFormationSections.map((row, index) => {
                const {
                  id,
                  sectionName,
                  sectionType,
                ...
                return (
                  <TableRow hover key={id ? id : index} tabIndex={-1}>
                    <TableCell>{index + 1}</TableCell>
                    <TableCell width={300}>{sectionName}</TableCell>
                    <TableCell>
                    ...
                    <TableCell align="center">{sectionDuration}</TableCell>
